...
ALARM_PATH := vendor/aanja/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aanja/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aanja/prebuilt/common/media/audio/ringtones
